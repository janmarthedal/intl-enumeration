Intl.supportedLocales = function (type) {
    var locales = Object.keys(LOCALES);
    return Intl[type].supportedLocalesOf(locales, { localeMatcher: 'lookup' });
}

// https://stackoverflow.com/a/28357857/212069
var LOCALES = {
